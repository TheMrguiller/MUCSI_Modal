...
from datasets_2 import create_downstream_dataset, BilbaoDataset
...
def get_args():
    ...
    parser.add_argument('--task', type=str, required=True, choices=['vqav2', 'bilbao'], help='Name of task to fine-tuning')
    ...
    parser.add_argument('--train_interpolation', type=str, default='bilinear',
    ...
    parser.add_argument('--fine_tune_bilbao', default=False, type=bool)
...
def main(args, ds_init):
    ...
    if not args.model.endswith(args.task) and args.task != 'bilbao':
    ...
    if bool(args.fine_tune_bilbao):
        model.head[-1] = torch.nn.Linear(768, 3).cuda()
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        #print("PEPE ? Freezing layers")
        #if args.fine_tune_bilbao and epoch < 1:
        #    print("Freezing layers")
        #    for name, parameter in model.named_parameters():
        #        if 'pooler' not in name and 'head' not in name:
